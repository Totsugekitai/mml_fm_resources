...
#endif
#define VERSION "Version 0.17(2008.04.19)"
//-----------------------------------------------------------------------------
// resource id's
...
CMouseEventResult CAbout::onMouseDown (CPoint &where, const long &buttons){

	pOPMdrv->ForceAllOff();
	return CSplashScreen::onMouseDown (where, buttons);
}
...
//-----------------------------------------------------------------------------
void VOPMEdit::setParameter(long index, float value)
{
	if (!frame)
		return;
